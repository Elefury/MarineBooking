    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <div class="bg-white shadow rounded-lg p-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Редактирование FAQ</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="answer" name="answer" rows="5" 
                                      class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>{{ old('answer', $faq->answer) }}</textarea>
                        </div>
